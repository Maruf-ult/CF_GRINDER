...
export default function Navbar({
  ...
  return (
    <nav className="flex items-center space-x-4 border-b border-gray-200 bg-blue-50 py-12 px-4 sticky top-0 z-10 pr-12 shadow-sm overflow-x-auto no-scrollbar">
      <input
      ...
      <div className="flex items-center ml-2 space-x-3">
        {FILTER_OPTIONS.map((option) => (
          <button
            ...
            className={`px-4.5 py-[19px] text-xs font-bold transition-all border cursor-pointer whitespace-nowrap  active:scale-95
              ${activeFilter === option 
